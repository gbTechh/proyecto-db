...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT . "/public/assets/css/main.css"?>">
    <link rel="stylesheet" href="<?php echo URLROOT . "/public/assets/css/layout.css"?>">
    <?php 
    if (isset($styles)) {
        foreach ($styles as $style) {
            echo "<link rel='stylesheet' href='" . URLROOT . "/public/assets/css/{$style}.css'>\n";
        }
    }
    ?>
...
<body>
      ...
      <div class="container-hero">
        <div class="container hero">
          ...
          <div class="container-logo">
            ...
            <h1 class="logo"><a href="<?php echo URLROOT . "/public"?>">Around the world</a></h1>
          </div>
            ...
            <div class="iniciar-sesion">
              ...
              <?php if (isset($_SESSION['username'])): ?>
                ...
                <div class="hover-container">
                  ...
                  <span id="boton_logout" class="text"><a href="<?php echo URLROOT . "/logout.php"?>">Cerrar sesión</a></span>
                </div>
              
              <?php else: ?>
                <span id="iniciar-sesion-click" class="text"><a href="<?php echo URLROOT . "/login.php"?>">Iniciar sesión</a></span>
              <?php endif; ?>
    ...
    if (isset($scripts)) {
        foreach ($scripts as $script) {
            echo "<script src='". URLROOT. "/public/assets/js/{$script}.js'></script>\n";
        }
    }
    ?>          
</body>
