...
class Login {
    ...
    private $apellidos;
    private $telefono;
    private $name_sucursal;
    private $id_sucursal;
    private $puesto;
    private $e_username;
    private $e_password;

    public function __construct($dni, $nombre, $apellidos, $telefono,$name_sucursal, $id_sucursal, $puesto, $e_username, $e_password) {
        $this->dni = $dni;
        $this->nombre = $nombre;
    ...
    public function getSucursal() { return $this->name_sucursal; }
    public function getIdSucursal() { return $this->id_sucursal; }
    ...
    public function setSucursal($sucursal) { $this->name_sucursal = $sucursal; }
    public function setIdSucursal($id_sucursal) { $this->id_sucursal = $id_sucursal; }
